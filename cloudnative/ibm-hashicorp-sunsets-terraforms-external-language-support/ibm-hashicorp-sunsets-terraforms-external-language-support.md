<!--
title: IBM HashiCorp官宣：Terraform外部语言支持被终结
cover: https://cdn.thenewstack.io/media/2025/12/65e7b1bd-ritu-dahiya-w2mlnx4yso-unsplash.jpg
summary: IBM旗下HashiCorp停止支持Terraform CDK，专注于HCL。现有CDK代码将不再维护。社区反响强烈，但IBM鼓励用户迁移至HCL，认为其更适合运维。
-->

IBM旗下HashiCorp停止支持Terraform CDK，专注于HCL。现有CDK代码将不再维护。社区反响强烈，但IBM鼓励用户迁移至HCL，认为其更适合运维。

> 译自：[IBM HashiCorp 'Sunsets' Terraform's External Language Support](https://thenewstack.io/ibm-hashicorp-sunsets-terraforms-external-language-support/)
> 
> 作者：Joab Jackson
