...
<!--
title: Argo项目如何避免WordPress式的问题
cover: https://cdn.thenewstack.io/media/2024/10/e62150b5-argo.png
-->

Argo 项目由不同的终端用户公司共同维护，因此任何公司都不可能掌控并更改许可证。

> 译自 [How the Argo Project Is Avoiding WordPress-Type Problems](https://thenewstack.io/how-the-argo-project-is-avoiding-wordpress-type-problems/)，作者 Dan Garfield。
