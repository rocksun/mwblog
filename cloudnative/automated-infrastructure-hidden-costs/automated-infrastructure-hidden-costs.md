<!--
title: 自动化基础设施的隐性成本：远超你的想象
cover: https://cdn.thenewstack.io/media/2026/02/e1e0097a-milhad-yaktvxoa6gc-unsplash-scaled.jpg
summary: 文章探讨了自动化蔓延带来的隐性成本，包括认知负荷、维护耗时和安全风险，并提出了通过盘点、建立模式和运维即代码等方法进行整合的策略，以提高效率并降低技术债务。
-->

文章探讨了自动化蔓延带来的隐性成本，包括认知负荷、维护耗时和安全风险，并提出了通过盘点、建立模式和运维即代码等方法进行整合的策略，以提高效率并降低技术债务。

> 译自：[Why "automated" infrastructure might cost more than you think](https://thenewstack.io/automated-infrastructure-hidden-costs/)
> 
> 作者：Justyn Roberts
