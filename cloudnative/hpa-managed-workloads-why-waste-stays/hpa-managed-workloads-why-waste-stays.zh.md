...
CloudBolt 帮助平台团队将 Kubernetes 优化洞察转化为安全、可信的行动——提供在生产环境中自信运营所需的护栏、可见性和控制。

[订阅 YOUTUBE.COM/THENEWSTACK

技术发展迅速，不要错过任何一集。订阅我们的 YouTube 频道，收看我们所有的播客、采访、演示等。

[立即订阅](https://youtube.com/thenewstack?sub_confirmation=1)
...
Yasmin Rajabi 是 CloudBolt Software 的首席运营官。她是 FinOps 和 Kubernetes 社区公认的领导者，她作为工程师、产品领导者和运营者的背景，使她对挑战有着全面的视角……

[阅读更多来自 Yasmin Rajabi 的内容](https://thenewstack.io/author/yasmin-rajabi/)