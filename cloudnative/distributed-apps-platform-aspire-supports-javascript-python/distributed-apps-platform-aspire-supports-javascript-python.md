<!--
title: Aspire平台重磅升级：全面支持JavaScript与Python
cover: https://cdn.thenewstack.io/media/2024/04/d8b458d6-dev_news_img-2-2.png
summary: 微软Aspire平台全面支持JavaScript、Python；Rust 1.93.0提升Linux应用稳定性；实用性黑客马拉松启动；Kaggle推出AI模型社区基准。
-->

微软Aspire平台全面支持JavaScript、Python；Rust 1.93.0提升Linux应用稳定性；实用性黑客马拉松启动；Kaggle推出AI模型社区基准。

> 译自：[Distributed apps platform Aspire supports JavaScript, Python](https://thenewstack.io/distributed-apps-platform-aspire-supports-javascript-python/)
> 
> 作者：Loraine Lawson
