...
summary: Whamm是卡内基梅隆大学Elizabeth Gilbert开发的WebAssembly应用插桩框架，用于调试、监控等。它支持语言互操作性，通过插桩、动态分析和字节码重写实现，目前需要更多贡献以完善用例。
-->

Whamm是卡内基梅隆大学Elizabeth Gilbert开发的WebAssembly应用插桩框架，用于调试、监控等。它支持语言互操作性，通过插桩、动态分析和字节码重写实现，目前需要更多贡献以完善用例。

> 译自：[Meet Whamm: The WebAssembly Instrumentation Framework](https://thenewstack.io/meet-whamm-the-webassembly-instrumentation-framework/)
> 
> 作者：B. Cameron Gain
