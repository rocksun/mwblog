...
summary: Sam Selikoff 质疑 Next.js RSC 缺乏灵敏导航。Next.js 通过 Cache Components 解决，利用部分预渲染和预加载，实现即时客户端导航，恢复 React 优势。
-->

Sam Selikoff 质疑 Next.js RSC 缺乏灵敏导航。Next.js 通过 Cache Components 解决，利用部分预渲染和预加载，实现即时客户端导航，恢复 React 优势。

> 译自：[How Next.js Got Its Snappy Client Navs Back](https://thenewstack.io/how-next-js-got-its-snappy-client-navs-back/)
> 
> 作者：Loraine Lawson
