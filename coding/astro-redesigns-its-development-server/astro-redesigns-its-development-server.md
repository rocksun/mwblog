...
summary: 本文介绍了Astro 6开发服务器重设计、Waku更新Cloudflare Worker适配器、Svelte漏洞修复、Bun高性能基准测试及MCP服务器构建现状。
-->

本文介绍了Astro 6开发服务器重设计、Waku更新Cloudflare Worker适配器、Svelte漏洞修复、Bun高性能基准测试及MCP服务器构建现状。

> 译自：[Astro Redesigns Its Development Server](https://thenewstack.io/astro-redesigns-its-development-server/)
> 
> 作者：Loraine Lawson
