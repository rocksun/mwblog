<!--
title: 开发者为何告别框架，转投原生JS？
cover: https://cdn.thenewstack.io/media/2025/12/1250a8c4-getty-images-p8d2uxktimu-unsplashb.jpg
summary: 开发者因框架疲劳回归原生JavaScript。现代浏览器API成熟，AI助力简洁开发，性能优先，微前端兴起。这是一场对复杂性的重置，旨在提升效率和开发者自主性。
-->

开发者因框架疲劳回归原生JavaScript。现代浏览器API成熟，AI助力简洁开发，性能优先，微前端兴起。这是一场对复杂性的重置，旨在提升效率和开发者自主性。

> 译自：[Why Developers Are Ditching Frameworks for Vanilla JavaScript](https://thenewstack.io/why-developers-are-ditching-frameworks-for-vanilla-javascript/)
> 
