<!--
title: 微软雄心壮志：Rust誓取代10亿行C/C++代码
cover: https://cdn.thenewstack.io/media/2025/12/356e9682-michael-schaffler-mrtj1jph8xq-unsplash-1.jpg
summary: 微软计划2030年前用Rust替换C/C++代码，提升内存安全、并发性与性能。将利用AI和算法高效重写代码，并招聘Rust工程师。
-->

微软计划2030年前用Rust替换C/C++代码，提升内存安全、并发性与性能。将利用AI和算法高效重写代码，并招聘Rust工程师。

> 译自：[Microsoft's Bold Goal: Replace 1B Lines of C/C++ With Rust](https://thenewstack.io/microsofts-bold-goal-replace-1b-lines-of-c-c-with-rust/)
> 
> 作者：Darryl K. Taft
