...
summary: OpenTelemetry eBPF Instrumentation (OBI)发布首个Alpha版。它利用eBPF技术实现零侵入、跨语言、协议层面的应用监控，自动捕获指标和追踪，性能优异，可与现有OpenTelemetry方案结合。
-->

OpenTelemetry eBPF Instrumentation (OBI)发布首个Alpha版。它利用eBPF技术实现零侵入、跨语言、协议层面的应用监控，自动捕获指标和追踪，性能优异，可与现有OpenTelemetry方案结合。

> 译自：[OpenTelemetry eBPF Instrumentation Marks the First Release](https://opentelemetry.io/blog/2025/obi-announcing-first-release/)
> 
> 作者：Nikola Grcevski
