<!--
title: Prometheus与OpenTelemetry：终告和解，强强联手
cover: https://cdn.thenewstack.io/media/2026/02/d2c52190-getty-images-_qbeky3gxeq-unsplash.jpg
summary: 文章指出，Prometheus和OpenTelemetry之间的兼容性问题已随Prometheus 3.0的发布而基本解决。Prometheus现在支持UTF-8和OTLP原生增强，极大地促进了两者的集成，为用户提供了更顺畅的指标、追踪和日志可观测性体验。
-->

文章指出，Prometheus和OpenTelemetry之间的兼容性问题已随Prometheus 3.0的发布而基本解决。Prometheus现在支持UTF-8和OTLP原生增强，极大地促进了两者的集成，为用户提供了更顺畅的指标、追踪和日志可观测性体验。

> 译自：[Prometheus and OpenTelemetry finally play nice](https://thenewstack.io/prometheus-and-opentelemetry-love-each-other-more-than-in-the-past/)
> 
> 作者：B. Cameron Gain
