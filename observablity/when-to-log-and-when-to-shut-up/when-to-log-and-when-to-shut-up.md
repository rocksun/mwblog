...
summary: 大多数日志是噪音。应选择性、有上下文、结构化地记录。结合追踪和指标，避免过度记录，使用工具，有目的地记录重要信息。
-->

大多数日志是噪音。应选择性、有上下文、结构化地记录。结合追踪和指标，避免过度记录，使用工具，有目的地记录重要信息。

> 译自：[When To Log, and When To Shut Up](https://thenewstack.io/when-to-log-and-when-to-shut-up/)
> 
> 作者：Mike Shi
