...
<!--
title: AI Agent可观测性-不断演进的标准和最佳实践
...
![AI agent application vs AI agent framework](https://opentelemetry.io/blog/2025/ai-agent-observability/agent-agent-framework.png)
