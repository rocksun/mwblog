...
**Zipkin** 是一个优秀的替代方案，它具有类似的功能并且符合 OpenTelemetry 标准。**Elastic APM** 是一个完整的可观测性解决方案，原生支持追踪、指标和日志。**Datadog 和 New Relic** 是提供深度可观测性功能的专有软件。
