<!--
title: Uptime Kuma免费容器：服务器监控神器
cover: https://cdn.thenewstack.io/media/2025/12/6aae6599-philip-oroni-pdmfgmcz3us-unsplash.jpg
summary: Uptime Kuma是一款易用的Docker容器监控工具，可监控Ping、HTTP、MySQL、Docker等多种服务。安装涉及Docker安装和Uptime Kuma部署，然后可添加主机进行监控。
-->

Uptime Kuma是一款易用的Docker容器监控工具，可监控Ping、HTTP、MySQL、Docker等多种服务。安装涉及Docker安装和Uptime Kuma部署，然后可添加主机进行监控。

> 译自：[Monitor Your Servers With Free Uptime Kuma Container](https://thenewstack.io/monitor-your-servers-with-free-uptime-kuma-container/)
> 
> 作者：Jack Wallen
