...
| Using `http.request.method` for business actions | “approve\_payment” isn’t an HTTP method |
...
* `http.response.status_code` - “status\_code” is one logical component
* `system.memory.usage_percent` - “usage\_percent” is one measurement concept
