<!--
title: 提升 Dapr 异步工作流的可观测性
cover: https://opentelemetry.io/img/social/logo-wordmark-001.png
summary: 文章介绍了 Dapr 团队如何通过增强 OpenTelemetry 集成，解决异步工作流跟踪上下文传播难题，实现 Jaeger 连贯跟踪，并探索语义对齐与异步行为建模，为云原生项目提供协作范例。
-->

文章介绍了 Dapr 团队如何通过增强 OpenTelemetry 集成，解决异步工作流跟踪上下文传播难题，实现 Jaeger 连贯跟踪，并探索语义对齐与异步行为建模，为云原生项目提供协作范例。

> 译自：[Improving Async Workflow Observability in Dapr](https://opentelemetry.io/blog/2026/dapr-workflow-observability/)
> 
> 作者：**[Mauricio “Salaboy” Salatino](https://github.com/salaboy) (Diagrid), [Kasper Borg Nissen](https://github.com/kaspernissen) (Dash0)**
...
![Dapr 工作流 gRPC 流式传输](https://opentelemetry.io/blog/2026/dapr-workflow-observability/dapr-workflow.png)
...
![Jaeger 跟踪](https://opentelemetry.io/blog/2026/dapr-workflow-observability/jaeger.jpg)
