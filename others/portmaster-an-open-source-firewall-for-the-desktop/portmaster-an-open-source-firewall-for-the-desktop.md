...
<!--
title: Portmaster：桌面开源防火墙
cover: https://cdn.thenewstack.io/media/2025/11/f6dc5166-getty-images-onqeqiif4ny-unsplash.jpg
summary: Portmaster是一款免费应用防火墙，可增强桌面安全。它监控并阻止应用程序连接，拦截广告、追踪器、恶意软件等，支持Linux/Windows，易于安装使用。
-->

Portmaster是一款免费应用防火墙，可增强桌面安全。它监控并阻止应用程序连接，拦截广告、追踪器、恶意软件等，支持Linux/Windows，易于安装使用。

> 译自：[Portmaster, an Open Source Firewall for the Desktop](https://thenewstack.io/portmaster-an-open-source-firewall-for-the-desktop/)
> 
> 作者：Jack Wallen
