<!--
title: 告别VMware和VirtualBox：这才是你的新虚拟机管理器
cover: https://cdn.thenewstack.io/media/2026/01/ec690520-airfocus-wrdvokfgzro-unsplash.jpg
summary: 本文介绍了作者放弃VirtualBox转向KVM/Virt-Manager的经历，并提供了使用KVM与Virt-Manager安装和创建虚拟机的详细教程，强调其卓越性能和可靠性。
-->

本文介绍了作者放弃VirtualBox转向KVM/Virt-Manager的经历，并提供了使用KVM与Virt-Manager安装和创建虚拟机的详细教程，强调其卓越性能和可靠性。

> 译自：[Forget VMware and VirtualBox: This should be your new VM manager](https://thenewstack.io/forget-vmware-and-virtualbox-this-should-be-your-new-vm-manager/)
> 
> 作者：Jack Wallen
...
你现在可以为操作系统分配所需的任意数量的 RAM 和 CPU 内核。
