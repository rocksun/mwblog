如果你从未用过 [Linux](https://thenewstack.io/introduction-to-linux-operating-system/)，并且现在正在[考虑使用它](https://thenewstack.io/learning-linux-start-here/)，那么你必然会遇到一件事，那就是选择。

使用 Linux，你可以[选择你的发行版](https://thenewstack.io/choosing-a-linux-distribution/)、内核、init 系统、文件系统类型、引导加载程序、默认应用程序以及你的桌面环境。
...
为了让这*更加*令人困惑，一些窗口管理器被设计为充当你的桌面用户界面，而无需同时安装桌面环境。
...
让我们以一个引人注目的方式开始，因为 [GNOME](https://www.gnome.org/) 是我所说的 Linux “三大”桌面之一。GNOME 是“极简主义者梦想成真”。[GNOME 背后的理念](https://thenewstack.io/what-makes-gnome-so-appealing/)是避免干扰，让你能够专注于需要做的事情。
...
如果你不喜欢收藏夹栏被隐藏起来，你可以安装 [GNOME 扩展](https://extensions.gnome.org/)，例如 Dash To Panel 或 Dash to Dock。有大量的 GNOME 扩展可供选择，它们将扩展你桌面的功能集。
...
[KDE Plasma](https://kde.org/plasma-desktop/) 不仅是市场上最漂亮的桌面环境之一，而且也是[可配置性最强](https://thenewstack.io/linux-desktop-what-makes-kde-plasma-so-appealing/)的桌面环境之一。开箱即用的体验会立刻让你感到熟悉，因为它具备桌面所有的常见特性：面板、开始菜单、系统托盘和可点击的图标。
...
![](https://cdn.thenewstack.io/media/2026/01/0d26d4ec-shells-neon.png)
...
[Cinnamon](https://projects.linuxmint.com/cinnamon/) 是 Linux Mint 的默认桌面，而 Linux Mint 恰好是现有最流行的 Linux 发行版之一。如果 Linux Mint 对我尊敬的同事 Steven J. Vaughan-Nichols 来说足够好，那么对任何人来说都足够好。相信我，他比大多数人都更了解开源。

说真的，[Linux Mint](https://thenewstack.io/reasons-to-love-linux-mint/) 是我通常推荐给那些想初次尝试 Linux 的人的发行版。其中一个非常好的理由就是 Cinnamon。

![Screenshot](https://cdn.thenewstack.io/media/2026/01/230b7f5c-welcome_screen_mint_21_1.png)
...
和 Cinnamon 一样，[Xfce](https://www.xfce.org/) 也让人立刻感到熟悉。默认配置包括面板、桌面菜单、系统托盘和可点击图标。尽管 Cinnamon 的可定制性很强，但市场上很少有桌面能像 Xfce 那样灵活多变。

除此之外，Xfce 速度极快。和 Cinnamon 一样，Xfce 被认为是轻量级桌面环境，但就速度而言，我不得不把胜利判给 Xfce。这也是为什么许多轻量级 Linux 发行版都默认使用 Xfce 的原因之一。

![Screenshot](https://cdn.thenewstack.io/media/2026/01/0c56b589-thunar_expandable_folders.png)
...
一开始可能有点令人困惑，但好消息是 [i3](https://i3wm.org/) 是一款适合从未用过平铺式窗口管理器的人的平铺式窗口管理器。
...
![i3 screenshot](https://cdn.thenewstack.io/media/2026/01/b38fdf3d-i3.jpg)
