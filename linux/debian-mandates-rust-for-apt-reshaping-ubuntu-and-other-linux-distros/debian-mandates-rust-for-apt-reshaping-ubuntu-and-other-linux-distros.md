...
summary: Debian宣布将Rust作为APT核心语言，以提升系统安全性和稳定性。此举将影响所有Debian系发行版，未适配Rust的旧架构将停止维护。
-->

Debian宣布将Rust作为APT核心语言，以提升系统安全性和稳定性。此举将影响所有Debian系发行版，未适配Rust的旧架构将停止维护。

> 译自：[Debian Mandates Rust for APT, Reshaping Ubuntu and Other Linux Distros](https://thenewstack.io/debian-mandates-rust-for-apt-reshaping-ubuntu-and-other-linux-distros/)
> 
