<!--
title: CrunchBang Linux 精神不灭，GreenBang 续写传奇
cover: https://cdn.thenewstack.io/media/2025/12/f8b6c36b-greenbanghero-1.jpg
summary: GreenBang是基于Arch Linux的发行版，采用Labwc窗口管理器，极简、快速。适合喜欢命令行和传统Linux体验的用户。
-->

GreenBang是基于Arch Linux的发行版，采用Labwc窗口管理器，极简、快速。适合喜欢命令行和传统Linux体验的用户。

> 译自：[CrunchBang Linux Lives on With GreenBang](https://thenewstack.io/crunchbang-linux-lives-on-with-greenbang/)
> 
> 作者：Jack Wallen
