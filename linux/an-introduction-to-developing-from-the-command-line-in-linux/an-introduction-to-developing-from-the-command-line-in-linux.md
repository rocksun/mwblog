...
<!--
title: Linux命令行开发入门
cover: https://cdn.thenewstack.io/media/2024/11/112ef20c-gabriel-heinzer-xbevm6oj1fs-unsplash.jpg
-->

本教程是使用命令行工具而不是功能齐全的IDE在Linux中编写代码的初学者指南。

> 译自 [An Introduction To Developing From the Command Line in Linux](https://thenewstack.io/an-introduction-to-developing-from-the-command-line-in-linux/)，作者 Jack Wallen。
