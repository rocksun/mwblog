<!--
title: Linux 7.1 终结37年传奇：Intel 486处理器不再受支持
cover: https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2026/02/windows-apps-on-linux.jpg?w=1600&h=900&fit=crop
summary: Linux 7.1 将停止对拥有37年历史的i486处理器提供内置支持。Linus Torvalds认为维护旧硬件兼容性会浪费开发资源。建议i486用户使用LTS内核或旧版发行版。
-->

Linux 7.1 将停止对拥有37年历史的i486处理器提供内置支持。Linus Torvalds认为维护旧硬件兼容性会浪费开发资源。建议i486用户使用LTS内核或旧版发行版。

> 译自：[Linux 7.1 is finally ending support for Intel's 37-year-old 486 processor](https://www.xda-developers.com/linux-7-1-finally-dropping-support-intels-37-year-old-486-processor/)
> 
> 作者：[no-author]
