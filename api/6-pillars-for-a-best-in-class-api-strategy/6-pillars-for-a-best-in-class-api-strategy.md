...
summary: Jason Ehmke指出AI网关无法解决所有API问题，需要API平台来自动化安全与治理。他提出了API平台成功的六大支柱：明确策略标准、API生命周期管理、自动化工具、安全合规、开发者体验以及监控指标。避免高层支持缺失、网关依赖、副总裁例外、手动操作和开发者抵触等陷阱至关重要。
-->
...
> 译自：[6 Pillars for a Best in Class API Strategy](https://thenewstack.io/6-pillars-for-a-best-in-class-api-strategy/)
> 
> 作者：Loraine Lawson
