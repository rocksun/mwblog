<!--
title: Adafruit：Arduino规则与开源“格格不入”
cover: https://cdn.thenewstack.io/media/2025/12/a5d9a558-getty-images-kl926rmswba-unsplash.jpg
summary: 开源硬件社区争议Arduino新条款。Adafruit批评其限制逆向工程、用户数据控制及AI用途。Arduino辩称限制仅限云服务，并承诺开源精神不变。EFF对许可不可撤销表担忧。
-->

开源硬件社区争议Arduino新条款。Adafruit批评其限制逆向工程、用户数据控制及AI用途。Arduino辩称限制仅限云服务，并承诺开源精神不变。EFF对许可不可撤销表担忧。

> 译自：[Adafruit: Arduino's Rules Are 'Incompatible With Open Source'](https://thenewstack.io/adafruit-arduinos-rules-are-incompatible-with-open-source/)
> 
> 作者：David Cassel
