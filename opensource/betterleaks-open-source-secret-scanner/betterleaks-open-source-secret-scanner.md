...
<!--
title: Gitleaks 作者携 Betterleaks 归来：专为 AI 时代打造的开源秘密扫描神器
cover: https://cdn.thenewstack.io/media/2026/03/76bda51c-getty-images-g1rpgnhyxfw-unsplash-scaled.jpg
summary: Gitleaks 创建者 Zach Rice 推出 Betterleaks，一个针对 AI 时代的新开源秘密扫描器。它改进了检测方法和速度，旨在应对 AI 生成代码带来的秘密泄露风险，并由 Aikido 赞助。
-->

Gitleaks 创建者 Zach Rice 推出 Betterleaks，一个针对 AI 时代的新开源秘密扫描器。它改进了检测方法和速度，旨在应对 AI 生成代码带来的秘密泄露风险，并由 Aikido 赞助。

> 译自：[Gitleaks creator returns with Betterleaks, an open source secrets scanner for the agentic era](https://thenewstack.io/betterleaks-open-source-secret-scanner/)
> 
> 作者：Paul Sawers
