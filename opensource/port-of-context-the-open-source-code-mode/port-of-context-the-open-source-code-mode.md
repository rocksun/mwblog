<!--
title: Port of Context：解锁开源代码模式
cover: https://cdn.thenewstack.io/media/2026/01/888a54a5-port-of-context-2.jpg
summary: MCP工具易致AI模型上下文窗口超载。开源项目Port of Context提供厂商无关的代码模式，高效减少令牌消耗，优化AI代理与外部工具交互。
-->

MCP工具易致AI模型上下文窗口超载。开源项目Port of Context提供厂商无关的代码模式，高效减少令牌消耗，优化AI代理与外部工具交互。

> 译自：[Port of Context: The open source code mode](https://thenewstack.io/port-of-context-the-open-source-code-mode/)
> 
> 作者：Bill Doerrfeld
