<!--
title: 开源Whamm：WebAssembly赋能，实时监测与修复运行中应用
cover: https://cdn.thenewstack.io/media/2026/01/6954299d-boitumelo-_8gr561qtea-unsplash.jpg
summary: Whamm是WebAssembly插桩框架，用于调试、监控和操纵Wasm应用。安装需Homebrew、Git、Rust和Wasm目标。它能提升Wasm应用的可观测性并动态修复错误。
-->

Whamm是WebAssembly插桩框架，用于调试、监控和操纵Wasm应用。安装需Homebrew、Git、Rust和Wasm目标。它能提升Wasm应用的可观测性并动态修复错误。

> 译自：[Open Source Whamm: Use WebAssembly To Monitor and Fix Running Apps](https://thenewstack.io/open-source-whamm-use-webassembly-to-monitor-and-fix-running-apps/)
> 
> 作者：B. Cameron Gain
