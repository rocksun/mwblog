<!--
title: 开源的未来：当项目“尘埃落定”
cover: https://cdn.thenewstack.io/media/2025/12/ae0d1da8-fork-scaled.jpg
summary: 文章强调“已完成”开源软件的价值。它们是稳定基石，但常面临维护者离开的挑战，如xz-utils事件。呼吁建立安全移交路径，并通过分叉机制确保项目可持续发展和创新。
-->

文章强调“已完成”开源软件的价值。它们是稳定基石，但常面临维护者离开的挑战，如xz-utils事件。呼吁建立安全移交路径，并通过分叉机制确保项目可持续发展和创新。

> 译自：[Put a Fork in It: The Future of Open Source That’s 'Done'](https://thenewstack.io/put-a-fork-in-it-the-future-of-open-source-thats-done/)
> 
> 作者：Dan Lorenc
