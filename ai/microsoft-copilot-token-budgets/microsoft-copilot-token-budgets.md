<!--
title: AI 编程的“盲目撒钱”时代已死，接下来该走向何方？
cover: https://cdn.thenewstack.io/media/2026/03/f6ed036e-ubaid-e-alyafizi-f1n95dhtrpg-unsplash-scaled.jpg
summary: 本文指出 AI 编程已告别盲目扩张期，微软通过引入 token 预算和精细化模型管理，强调从单纯追求使用量转向评估实际产出价值，以应对 AI 代带来的人力与计算成本失控难题。
-->

本文指出 AI 编程已告别盲目扩张期，微软通过引入 token 预算和精细化模型管理，强调从单纯追求使用量转向评估实际产出价值，以应对 AI 代带来的人力与计算成本失控难题。

> 译自：[The blank-check AI coding era is dead. Here's what comes next.](https://thenewstack.io/microsoft-copilot-token-budgets/)
> 
> 作者：Amanda Caswell
