<!--
title: Gemini CLI 编程指南：玩转命令行开发
cover: https://cdn.thenewstack.io/media/2025/12/c53c6c5d-ilnur-sxk8rucpqoq-unsplash.jpg
summary: 谷歌发布Gemini CLI，开源、本地运行的命令行工具。支持Gemini 2.5 Pro，功能强大，助你学习编程。安装需Node.js/NPM并认证。
-->

谷歌发布Gemini CLI，开源、本地运行的命令行工具。支持Gemini 2.5 Pro，功能强大，助你学习编程。安装需Node.js/NPM并认证。

> 译自：[Coding With the Gemini CLI Tool](https://thenewstack.io/coding-with-the-gemini-cli-tool/)
> 
> 作者：Jack Wallen
