<!--
title: 为什么 GPT-5.4、Claude 和 Gemini 无法在基础现实世界事实上达成一致
cover: https://cdn.thenewstack.io/media/2026/05/0856f4ce-prakasit-khuansuwan-8l6gtidqbsq-unsplash-scaled.jpg
summary: 分析显示，五个顶尖AI大模型在67%的现实事实核查中存在分歧，21%甚至得出相反结论。这表明大模型常识判断存在显著差异，开发者在高风险场景中应加强内容验证。
-->

分析显示，五个顶尖AI大模型在67%的现实事实核查中存在分歧，21%甚至得出相反结论。这表明大模型常识判断存在显著差异，开发者在高风险场景中应加强内容验证。

> 译自：[Why GPT-5.4, Claude, and Gemini can't agree on basic, real-world facts](https://thenewstack.io/frontier-llm-factcheck-disagreement/)
> 
