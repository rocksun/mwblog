...
> [OpenAI GPT-5.4 推出，AI 获得自己的就业报告，Claude 在美国禁令后飙升](https://thenewstack.io/openai-gpt-5-4-ai-jobs-report-anthropic-dow-supply-chain-risk/)

> [Perplexity Computer 令人惊叹，Karpathy 扼杀氛围编程，OpenAI 取代 Anthropic 进驻五角大楼](https://thenewstack.io/perplexity-computer-vibe-coding-openai-anthropic-pentagon/)

> [Claude Code 登陆 Roadmap，OpenClaw 失去头部，AI 工作流](https://thenewstack.io/claude-code-comes-to-roadmap-openclaw-loses-its-head-and-ai-workslop/)