...
Paul 是一位经验丰富的技术记者，报道欧洲及其他地区的一些重大新闻，最近在 TechCrunch 负责创业公司、企业、大型科技、基础设施、开源、AI、监管等。Paul 目前常驻伦敦...

阅读更多 Paul Sawers 的文章](https://thenewstack.io/author/paul-sawers/)