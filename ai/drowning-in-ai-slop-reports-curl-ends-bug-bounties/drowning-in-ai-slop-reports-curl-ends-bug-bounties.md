<!--
title: cURL被AI垃圾淹没，关闭漏洞赏金计划
cover: https://cdn.thenewstack.io/media/2024/03/6b5ad6d2-curl.png
summary: cURL因AI垃圾报告泛滥而关闭漏洞赏金计划。开发者Daniel Stenberg不满滥用AI的行为，但支持有效AI辅助找bug，并制定了严格的AI使用规则。
-->

cURL因AI垃圾报告泛滥而关闭漏洞赏金计划。开发者Daniel Stenberg不满滥用AI的行为，但支持有效AI辅助找bug，并制定了严格的AI使用规则。

> 译自：[Drowning in AI slop, cURL ends bug bounties](https://thenewstack.io/drowning-in-ai-slop-reports-curl-ends-bug-bounties/)
> 
