# 使用 LLM 构建 WordPress 的 Steampipe 仪表板
...
- 它没有使用 *wordpress.PostListOptions* 中的 *Context* 参数，因此无法使用 *context.WithTimeout* 来设置超时。
...
- 使用 *wordpress.PostListOptions* 中的 *MenuOrder* 参数过滤帖子菜单顺序。
