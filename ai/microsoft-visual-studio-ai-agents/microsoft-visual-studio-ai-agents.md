<!--
title: 微软解除Visual Studio限制，拥抱曾被其AI生态“冷落”的开发者
cover: https://cdn.thenewstack.io/media/2026/06/9c35f09c-jr-korpa-baqguqsot_i-unsplash.jpg
summary: 微软在Build 2026上宣布Visual Studio重大更新，允许开发者自带AI模型与密钥（BYOK），将智能体深度融入调试与测试工作流，并助力遗留应用现代化升级。
-->

微软在Build 2026上宣布Visual Studio重大更新，允许开发者自带AI模型与密钥（BYOK），将智能体深度融入调试与测试工作流，并助力遗留应用现代化升级。

> 译自：[Microsoft unlocks Visual Studio for developers left behind by its own AI](https://thenewstack.io/microsoft-visual-studio-ai-agents/)
> 
> 作者：Darryl K. Taft
