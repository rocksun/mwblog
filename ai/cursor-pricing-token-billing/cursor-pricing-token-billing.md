<!--
title: 面对“代币经济学”清算，Cursor降价并推出企业支出控制功能
cover: https://cdn.thenewstack.io/media/2026/06/e72eae78-jason-leung-93olkmqayv0-unsplash-scaled.jpg
summary: 面对AI按Token计费趋势，Cursor降价并推出企业级支出管控与分析工具，同时推出自研低成本模型Composer，以帮助企业应对不透明的AI消费成本。
-->

面对AI按Token计费趋势，Cursor降价并推出企业级支出管控与分析工具，同时推出自研低成本模型Composer，以帮助企业应对不透明的AI消费成本。

> 译自：[Cursor cuts prices and adds enterprise spend controls amid "tokenomics" reckoning](https://thenewstack.io/cursor-pricing-token-billing/)
> 
> 作者：Paul Sawers
