...
Finally, we can verify that our schema was applied successfully, we can re-run the `atlas schema apply`
command. Atlas
will output:
...
command. The method reads the markdown files from the specified
