...
summary: 谷歌Keith Ballinger谈AI编码：工具尚早期，需清晰指南和架构。未来编程将更抽象，开发者可能无需直接接触代码，重点是意图。优秀程序员亦是优秀作家。
-->

谷歌Keith Ballinger谈AI编码：工具尚早期，需清晰指南和架构。未来编程将更抽象，开发者可能无需直接接触代码，重点是意图。优秀程序员亦是优秀作家。

> 译自：[Stop Writing Code, Start Writing Docs](https://thenewstack.io/stop-writing-code-start-writing-docs/)
> 
