<!--
title: 超越Python：大语言模型为何亟需更稳定、更开放的开源代码？
cover: https://cdn.thenewstack.io/media/2026/01/3d8f0269-peter-neumann-d7ub_0oowgk-unsplashb.jpg
summary: LLM目前偏爱Python，但思维链提示可降低此偏好。未来JavaScript/Java及开源模型将影响趋势。代码可维护性和降低不确定性是关键，建议建立代码“种子库”。长远看，AI将开发自身语言。
-->

LLM目前偏爱Python，但思维链提示可降低此偏好。未来JavaScript/Java及开源模型将影响趋势。代码可维护性和降低不确定性是关键，建议建立代码“种子库”。长远看，AI将开发自身语言。

> 译自：[Beyond Python: Why LLMs Need More Stable, Open Source Code](https://thenewstack.io/beyond-python-why-llms-need-more-stable-open-source-code/)
> 
> 作者：David Eastman
