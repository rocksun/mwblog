<!--
title: 随着智能体 AI 爆发，亚马逊加码 MCP 协议
cover: https://cdn.thenewstack.io/media/2026/04/e4e24d70-thumbnail-6.png
summary: 本文探讨了亚马逊 AWS 如何深度参与开源 MCP 协议的开发。通过核心工程师的贡献，AWS 正助力构建 AI 智能体与数据连接的标准，推动自动化技术走向普惠。
-->

本文探讨了亚马逊 AWS 如何深度参与开源 MCP 协议的开发。通过核心工程师的贡献，AWS 正助力构建 AI 智能体与数据连接的标准，推动自动化技术走向普惠。

> 译自：[As agentic AI explodes, Amazon doubles down on MCP](https://thenewstack.io/amazon-aws-mcp-agentic/)
> 
> 作者：Alex Wilhelm
