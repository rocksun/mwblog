<!--
title: Nvidia 129亿美元收购Hugging Face面临开源难题
cover: https://cdn.thenewstack.io/media/2026/08/1e060290-logan-voss-lzbflvtjcqu-unsplash-scaled.jpg
summary: Nvidia拟以129亿美元收购Hugging Face。虽然此举巩固了其AI地位，但业界担忧这将破坏该平台的硬件中立性与开源价值，可能导致竞争对手减少对该生态的投入，进而影响开发者的跨硬件使用体验。
-->

Nvidia拟以129亿美元收购Hugging Face。虽然此举巩固了其AI地位，但业界担忧这将破坏该平台的硬件中立性与开源价值，可能导致竞争对手减少对该生态的投入，进而影响开发者的跨硬件使用体验。

> 译自：[Nvidia's $12.9B Hugging Face deal has an open-source problem](https://thenewstack.io/nvidia-hugging-face-acquisition-neutrality/)
> 
> 作者：Amanda Caswell
