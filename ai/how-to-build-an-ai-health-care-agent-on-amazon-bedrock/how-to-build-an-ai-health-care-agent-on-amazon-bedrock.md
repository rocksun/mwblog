...
summary: 本文介绍了使用 Amazon Bedrock Flows 构建一个医疗保健助手。该助手通过知识库回答疾病问题，并使用 Lambda 函数获取患者详细信息。文章详细说明了创建知识库、代理，以及构建 Streamlit 应用程序的步骤，最后集成了 Amazon Bedrock Flows。
-->
