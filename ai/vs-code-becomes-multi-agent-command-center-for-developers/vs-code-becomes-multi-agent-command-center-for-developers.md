<!--
title: VS Code 升级多智能体指挥中心，赋能开发者
cover: https://cdn.thenewstack.io/media/2026/02/263aa656-ana-garnica-wrx2tdzzgdw-unsplash-1.jpg
summary: VS Code v1.109升级为多智能体指挥中心，支持Claude、Codex与Copilot协同工作。新版本统一会话管理、引入并行子智能体和MCP应用，提升开发者AI协作效率。这体现了VS Code作为通用AI界面的战略。
-->

VS Code v1.109升级为多智能体指挥中心，支持Claude、Codex与Copilot协同工作。新版本统一会话管理、引入并行子智能体和MCP应用，提升开发者AI协作效率。这体现了VS Code作为通用AI界面的战略。

> 译自：[VS Code becomes multi-agent command center for developers](https://thenewstack.io/vs-code-becomes-multi-agent-command-center-for-developers/)
> 
> 作者：Darryl K. Taft
