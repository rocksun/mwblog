...
> [Perplexity Computer 令人惊叹，Karpathy 终结氛围编程，OpenAI 在五角大楼取代 Anthropic](https://thenewstack.io/perplexity-computer-vibe-coding-openai-anthropic-pentagon/)

> [Claude Code 登陆 Roadmap，OpenClaw 失去理智，以及 AI 工作流](https://thenewstack.io/claude-code-comes-to-roadmap-openclaw-loses-its-head-and-ai-workslop/)