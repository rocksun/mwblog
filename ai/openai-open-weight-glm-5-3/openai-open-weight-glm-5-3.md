<!--
title: OpenAI的Greg Brockman：Z.ai的GLM-5.3可能会“显著加速威胁格局的发展”
cover: https://cdn.thenewstack.io/media/2026/08/3f320915-allison-saeng-nrrwulr6nfq-unsplash-scaled.jpg
summary: OpenAI高管Greg Brockman对Z.ai即将发布的开源模型GLM-5.3表示担忧，认为其可能加速网络威胁发展。业界正就开源模型的安全风险与控制权展开激烈争论。
-->

OpenAI高管Greg Brockman对Z.ai即将发布的开源模型GLM-5.3表示担忧，认为其可能加速网络威胁发展。业界正就开源模型的安全风险与控制权展开激烈争论。

> 译自：[OpenAI's Greg Brockman: Z.ai's GLM-5.3 likely to "significantly accelerate the threat landscape"](https://thenewstack.io/openai-open-weight-glm-5-3/)
> 
> 作者：Paul Sawers
