...
summary: AWS Kiro推出“能力系统”，为AI智能体按需动态加载专业知识和工具，有效解决上下文过载问题。该系统包含配置、指导文件和钩子，支持社区共建，促进智能体持续学习。
-->

AWS Kiro推出“能力系统”，为AI智能体按需动态加载专业知识和工具，有效解决上下文过载问题。该系统包含配置、指导文件和钩子，支持社区共建，促进智能体持续学习。

> 译自：[AWS Tackles AI's 'Too Much Information' Problem](https://thenewstack.io/aws-tackles-ais-too-much-information-problem/)
> 
> 作者：Darryl K. Taft
