...
summary: Natural是一个轻量级JavaScript NLP库，提供分词、词干提取、文本分类、相似度测量和拼写检查等基本功能。它易于理解和构建，适用于简单的文本处理任务。
-->

Natural是一个轻量级JavaScript NLP库，提供分词、词干提取、文本分类、相似度测量和拼写检查等基本功能。它易于理解和构建，适用于简单的文本处理任务。

> 译自：[How To Perform Basic NLP in JavaScript With the Natural Library](https://thenewstack.io/how-to-perform-basic-nlp-in-javascript-with-the-natural-library/)
> 
> 作者：Jessica Wachtel
