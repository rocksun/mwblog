<!--
title: 22511个AI编码技能暗藏玄机：安全审计揭露代码深处潜伏的风险
cover: https://cdn.thenewstack.io/media/2026/03/4df79c5b-ekaterina-bogdan-y0hrs-dtb0-unsplash-1.jpg
summary: Mobb.ai审计了22,511个AI编码技能，发现14万余安全隐患和运行时验证漏洞。攻击者可利用此劫持API流量、窃取凭据。报告呼吁注册表、工具供应商和行业加强安全防护。
-->

Mobb.ai审计了22,511个AI编码技能，发现14万余安全隐患和运行时验证漏洞。攻击者可利用此劫持API流量、窃取凭据。报告呼吁注册表、工具供应商和行业加强安全防护。

> 译自：[What a security audit of 22,511 AI coding skills found lurking in the code](https://thenewstack.io/ai-agent-skills-security/)
> 
> 作者：Darryl K. Taft
