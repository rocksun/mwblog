<!--
title: BM25算法：在PostgreSQL中提升AI应用相关性的秘诀
cover: https://cdn.thenewstack.io/media/2025/12/11cf57b8-postgres.jpg
summary: Tiger Data开源pg_textsearch，用BM25算法强化PostgreSQL文本搜索，广受欢迎。更名因业务拓展至AI应用，旨将关键字与向量搜索整合入Postgres，简化数据架构。
-->

Tiger Data开源pg_textsearch，用BM25算法强化PostgreSQL文本搜索，广受欢迎。更名因业务拓展至AI应用，旨将关键字与向量搜索整合入Postgres，简化数据架构。

> 译自：[Better Relevance for AI Apps With BM25 Algorithm in PostgreSQL](https://thenewstack.io/better-relevance-for-ai-apps-with-bm25-algorithm-in-postgresql/)
> 
> 作者：Susan Hall
