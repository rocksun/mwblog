<!--
title: 我曾完全信赖Claude，但这次测试让我改变了看法
cover: https://cdn.thenewstack.io/media/2026/07/9bc73653-egor-komarov-eahtohw_wou-unsplash-scaled.jpg
summary: 文章通过对比测试发现，Grok 4.5在编程任务中能以Claude Opus约四分之一的Token消耗和成本，交付同等质量的代码，尽管Opus在文档完善度上略胜一筹。这对追求高性价比的开发者而言具有重要参考价值。
-->

文章通过对比测试发现，Grok 4.5在编程任务中能以Claude Opus约四分之一的Token消耗和成本，交付同等质量的代码，尽管Opus在文档完善度上略胜一筹。这对追求高性价比的开发者而言具有重要参考价值。

> 译自：[I trust Claude for everything. This test made me rethink that.](https://thenewstack.io/grok-opus-coding-tokens/)
> 
> 作者：Jessica Wachtel
