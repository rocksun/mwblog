...
<!--
title: 使用时间序列语言模型转换预测分析
cover: https://cdn.thenewstack.io/media/2024/08/bdc32aa4-snake-4912018_1280.jpg
-->

利用 ARIMA 和 GARCH 等高级时间序列模型，解锁新的洞察力并提高预测精度。

> 译自 [Transform Predictive Analytics With Time Series Language Models](https://thenewstack.io/transform-predictive-analytics-with-time-series-language-models/)，作者 Anais Dotis Georgiou。
...
![](https://cdn.thenewstack.io/media/2024/08/70f5ecf1-picture1.png)
...
- [Client Library Deep Dive: Python (Part 1)](https://www.influxdata.com/blog/client-library-deep-dive-python-part-1/)
- [Client Library Deep Dive: Python (Part 2)](https://www.influxdata.com/blog/client-library-deep-dive-python-part-2/)