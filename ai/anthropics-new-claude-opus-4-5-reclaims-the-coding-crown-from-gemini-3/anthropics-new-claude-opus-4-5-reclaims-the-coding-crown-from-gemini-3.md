...
summary: Anthropic发布Opus 4.5，编码能力达80.9%，超越竞品。API成本降低，新增“工作量”参数。增强视觉推理、数学，支持计算机使用。
-->

Anthropic发布Opus 4.5，编码能力达80.9%，超越竞品。API成本降低，新增“工作量”参数。增强视觉推理、数学，支持计算机使用。

> 译自：[Anthropic's New Claude Opus 4.5 Reclaims the Coding Crown](https://thenewstack.io/anthropics-new-claude-opus-4-5-reclaims-the-coding-crown-from-gemini-3/)
> 
