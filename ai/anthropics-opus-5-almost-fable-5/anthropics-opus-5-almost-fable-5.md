<!--
title: Anthropic的Opus 5表现近乎Fable 5
cover: https://cdn.thenewstack.io/media/2026/07/eaa8df91-screenshot-2026-07-24-at-7.56.08-am-1024x572.png
summary: Anthropic发布了最新模型Opus 5。该模型在多个领域表现接近旗舰款Fable 5，但在成本上仅为其一半，且无需强制数据保留，定位为企业级用户每日首选的生产力模型。在多项基准测试中，Opus 5性能优于Opus 4.8及竞争对手，并强化了安全性与合规性。
-->

Anthropic发布了最新模型Opus 5。该模型在多个领域表现接近旗舰款Fable 5，但在成本上仅为其一半，且无需强制数据保留，定位为企业级用户每日首选的生产力模型。在多项基准测试中，Opus 5性能优于Opus 4.8及竞争对手，并强化了安全性与合规性。

> 译自：[Anthropic’s Opus 5 is almost Fable 5](https://thenewstack.io/anthropics-opus-5-almost-fable-5/)
> 
