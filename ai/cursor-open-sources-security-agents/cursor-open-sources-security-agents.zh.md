...
> [SaaS 灾变临近了吗？为软件席位付费的时代可能即将结束。](https://thenewstack.io/dawn-of-a-saaspocalypse/)
...
在加入 The New Stack 担任人工智能高级编辑之前，Frederic 曾是 TechCrunch 的企业编辑，报道过从云计算兴起到 Kubernetes 的早期发展，再到量子计算的出现等一切内容……
