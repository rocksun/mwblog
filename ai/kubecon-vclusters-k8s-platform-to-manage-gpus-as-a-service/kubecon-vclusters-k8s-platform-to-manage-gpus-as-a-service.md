...
summary: VCluster Labs 发布专为 NVIDIA GPU 优化的 Kubernetes，旨在提高 AI 工作负载的 GPU 效率，提供灵活租户、高级隔离和动态扩展，并集成 NVIDIA BCM。
-->

VCluster Labs 发布专为 NVIDIA GPU 优化的 Kubernetes，旨在提高 AI 工作负载的 GPU 效率，提供灵活租户、高级隔离和动态扩展，并集成 NVIDIA BCM。

> 译自：[Kubecon: VCluster's K8s Platform to Manage GPUs as a Service](https://thenewstack.io/kubecon-vclusters-k8s-platform-to-manage-gpus-as-a-service/)
> 
> 作者：Joab Jackson
