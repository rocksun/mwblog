<!--
title: 厂商中立并非魔法：审视 OpenTelemetry 生态系统的真实面貌
cover: https://cdn.thenewstack.io/media/2026/05/6c65cff4-yana-kravchuk-z4uy44mxj1m-unsplash-scaled.jpg
summary: 本文深入探讨了OpenTelemetry的厂商中立性。虽然OTel在数据采集和传输上实现了高度中立，但在UI、存储、查询、告警和IaC等实际迁移层面依然存在壁垒。
-->

本文深入探讨了OpenTelemetry的厂商中立性。虽然OTel在数据采集和传输上实现了高度中立，但在UI、存储、查询、告警和IaC等实际迁移层面依然存在壁垒。

> 译自：[Vendor neutrality isn’t magic: A hard look at the OpenTelemetry ecosystem](https://thenewstack.io/opentelemetry-vendor-neutrality-guide/)
> 
> 作者：Adriana Villela, Josh Lee
