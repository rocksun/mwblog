<!--
title: 谷歌强推闭源 Antigravity CLI：开源 Gemini CLI 面临停用，引开发者吐槽
cover: https://cdn.thenewstack.io/media/2026/05/db296d07-getty-images-a8fug9n4psy-unsplash-scaled.jpg
summary: 谷歌宣布自6月18日起，将Pro、Ultra和免费用户从开源Gemini CLI强制过渡到闭源且功能受限的Antigravity CLI。此举因配额极低、费用更高引发开发者强烈不满。
-->

谷歌宣布自6月18日起，将Pro、Ultra和免费用户从开源Gemini CLI强制过渡到闭源且功能受限的Antigravity CLI。此举因配额极低、费用更高引发开发者强烈不满。

> 译自：[Google pushes Pro, Ultra, and free users from open-source Gemini CLI to closed-source Antigravity CLI](https://thenewstack.io/google-antigravity-cli/)
> 
> 作者：Meredith Shubel
