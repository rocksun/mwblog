...
summary: AWS推出三款AI代理：Kiro、安全和DevOps。它们能自主工作，作为团队成员，减少人工干预，提升SDLC效率，并持续学习。
-->

AWS推出三款AI代理：Kiro、安全和DevOps。它们能自主工作，作为团队成员，减少人工干预，提升SDLC效率，并持续学习。

> 译自：[AWS Frontier Agents Handle Code, Security, Ops Without You](https://thenewstack.io/aws-frontier-agents-handle-code-security-ops-without-you/)
> 
> 作者：Darryl K. Taft
