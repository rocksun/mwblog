<!--
title: 当Mistral切换开关时，你的索引数据会发生什么？
cover: https://cdn.thenewstack.io/media/2026/08/e1663c08-randy-laybourne-odhxvqqu9ru-unsplash-scaled.jpg
summary: Mistral要求企业在8月31日前将Google Drive和SharePoint连接器迁移至MCP替代方案。此次强制迁移缺乏自动化流程，且由于MCP架构变动，企业在权限管理、数据缓存及安全性等方面面临不确定性，亟需管理者关注数据合规风险。
-->

Mistral要求企业在8月31日前将Google Drive和SharePoint连接器迁移至MCP替代方案。此次强制迁移缺乏自动化流程，且由于MCP架构变动，企业在权限管理、数据缓存及安全性等方面面临不确定性，亟需管理者关注数据合规风险。

> 译自：[What happens to your indexed data when Mistral flips the switch?](https://thenewstack.io/mistral-mcp-connector-migration/)
> 
> 作者：Amanda Caswell
