<!--
title: Cloudflare“代理Markdown”：让网站即刻“AI就绪”
cover: https://cdn.thenewstack.io/media/2026/02/c001a324-ghariza-mahavira-den4voqcp-m-unsplash-scaled.jpg
summary: Cloudflare推出“适用于代理的Markdown”，将HTML转为Markdown，为AI代理节省高达80%的token，降低推理成本，提升网络内容处理效率。
-->

Cloudflare推出“适用于代理的Markdown”，将HTML转为Markdown，为AI代理节省高达80%的token，降低推理成本，提升网络内容处理效率。

> 译自：[Cloudflare's Markdown for Agents automatically make websites agent-ready](https://thenewstack.io/cloudflares-markdown-for-agents-automatically-make-websites-more-aifriendly/)
> 
