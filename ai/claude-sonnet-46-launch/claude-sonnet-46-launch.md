<!--
title: Anthropic Claude Sonnet 4.6 重磅发布：Opus 级编码，Sonnet 价享！
cover: https://cdn.thenewstack.io/media/2026/02/51b10f1a-img_2726-scaled.jpg
summary: Anthropic 发布 Claude Sonnet 4.6，以更低价格实现 Opus 级编码性能，在多项任务中超越前代并接近 Opus，成为默认模型。
-->

Anthropic 发布 Claude Sonnet 4.6，以更低价格实现 Opus 级编码性能，在多项任务中超越前代并接近 Opus，成为默认模型。

> 译自：[Anthropic's new Claude Sonnet 4.6 promises Opus-level coding at Sonnet pricing](https://thenewstack.io/claude-sonnet-46-launch/)
> 
