...
*了解更多关于[Salesforce Data 360](https://www.salesforce.com/data/%20)的代理能力，以及它如何通过提高推理、信任和准确性，将RAG提升到新的水平。*
...
Rahul Auradkar是Salesforce数据360和AI基础的执行副总裁兼总经理。

阅读更多Rahul Auradkar的文章](https://thenewstack.io/author/rahul-auradkar/)