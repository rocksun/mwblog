# 使用 LangChain、Chainlit 和 Literal AI 构建可观察的 arXiv RAG 聊天机器人
...
将可观察性功能集成到生产级应用程序中（例如我们的 Copilot 运行的语义研究引擎）通常是必需的，以确保应用程序在生产环境中的可靠性。我们将使用 Literal AI 框架来实现此目的。
