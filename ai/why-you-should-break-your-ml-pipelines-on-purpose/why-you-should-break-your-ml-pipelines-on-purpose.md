...
summary: 文章介绍了机器学习系统静默失效的风险，以及混沌工程在AI领域的应用。混沌工程通过主动注入故障来测试系统弹性，弥补了传统监控方法的不足。文章详细分析了数据摄取、特征工程、模型训练、部署、服务及监控等环节常见的故障模式，并强调了混沌工程在构建可靠AI系统中的重要性。
-->
...
> 译自：[Why You Should Break Your ML Pipelines on Purpose](https://thenewstack.io/why-you-should-break-your-ml-pipelines-on-purpose/)
> 
> 作者：Tinega Onchari
