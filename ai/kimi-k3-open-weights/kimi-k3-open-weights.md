<!--
title: 月之暗面开源Kimi K3权重，但能运行它的人寥寥无几
cover: https://cdn.thenewstack.io/media/2026/03/682d9187-getty-images-umj0nxosynq-unsplash-scaled.jpg
summary: 月之暗面开源了Kimi K3大模型，其超大规模参数和高性能对企业自建部署提出了极高的硬件要求。尽管该模型在编程和知识密集型任务中表现优异，且兼容OpenAI API，但企业需权衡基础设施的高昂成本、潜在的合规性风险及与美国前沿模型的性能差异。
-->

月之暗面开源了Kimi K3大模型，其超大规模参数和高性能对企业自建部署提出了极高的硬件要求。尽管该模型在编程和知识密集型任务中表现优异，且兼容OpenAI API，但企业需权衡基础设施的高昂成本、潜在的合规性风险及与美国前沿模型的性能差异。

> 译自：[Moonshot opens Kimi K3 weights — but few can run it](https://thenewstack.io/kimi-k3-open-weights/)
> 
> 作者：Amanda Caswell
