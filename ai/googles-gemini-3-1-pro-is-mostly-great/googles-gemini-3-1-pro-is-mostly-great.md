<!--
title: 谷歌Gemini 3.1 Pro：虽非完美，但卓越不凡
cover: https://cdn.thenewstack.io/media/2026/02/08eb79e4-mitchell-luo-jz4ca36oj_m-unsplash-scaled.jpg
summary: 谷歌发布Gemini 3.1 Pro，在推理和编程方面表现显著提升，超越多数竞品。其核心智能源自Deep Think模型，定价具竞争力，已广泛可用。但其在特定现实任务（GDPval-AA）上表现不佳。
-->

谷歌发布Gemini 3.1 Pro，在推理和编程方面表现显著提升，超越多数竞品。其核心智能源自Deep Think模型，定价具竞争力，已广泛可用。但其在特定现实任务（GDPval-AA）上表现不佳。

> 译自：[Google's Gemini 3.1 Pro is mostly great](https://thenewstack.io/googles-gemini-3-1-pro-is-mostly-great/)
> 
