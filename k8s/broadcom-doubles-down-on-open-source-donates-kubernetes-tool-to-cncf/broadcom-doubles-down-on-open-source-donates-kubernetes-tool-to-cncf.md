...
summary: 博通在KubeCon上重申对开源和VMware的支持，并加强对CNCF的贡献。博通仍是CNCF前五大开源贡献者，加大投入etcd工具和Cluster API。可靠的开源参与是博通VMware成功的关键。
-->

博通在KubeCon上重申对开源和VMware的支持，并加强对CNCF的贡献。博通仍是CNCF前五大开源贡献者，加大投入etcd工具和Cluster API。可靠的开源参与是博通VMware成功的关键。

> 译自：[Broadcom ‘Doubles Down’ on Open Source, Donates Kubernetes Tool to CNCF](https://thenewstack.io/broadcom-doubles-down-on-open-source-donates-kubernetes-tool-to-cncf/)
> 
> 作者：B. Cameron Gain
