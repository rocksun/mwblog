...
summary: Beszel是一款Docker容器监控工具，提供用户友好的Web界面，支持Docker统计、历史和警报。部署简单，可轻松监控多台机器的容器资源使用情况。
-->

Beszel是一款Docker容器监控工具，提供用户友好的Web界面，支持Docker统计、历史和警报。部署简单，可轻松监控多台机器的容器资源使用情况。

> 译自：[Monitor Docker Containers Across Servers With Beszel](https://thenewstack.io/monitor-docker-containers-across-servers-with-beszel/)
> 
> 作者：Jack Wallen
...
services:
  beszel-agent:
    ...
    environment:
      ...
      HUB_URL: http://192.168.1.26:8090
```
