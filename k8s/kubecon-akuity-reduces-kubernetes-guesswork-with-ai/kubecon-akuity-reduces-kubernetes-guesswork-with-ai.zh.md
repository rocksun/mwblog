亚特兰大 — 云原生 GitOps 服务提供商

[Akuity](https://akuity.io)

已在其 Kubernetes 部署平台中加入了生成式 AI 辅助功能，旨在帮助系统运维人员更好地管理事故和错误配置。

本周在亚特兰大参加

[KubeCon+CloudNativeCon 2025](https://events.linuxfoundation.org/kubecon-cloudnativecon-north-america/?utm_source=the+new+stack&utm_medium=referral&utm_campaign=event)

的参会者可以前往 #830 展位，亲身体验 Akuity 平台及其 AI 增强功能。
