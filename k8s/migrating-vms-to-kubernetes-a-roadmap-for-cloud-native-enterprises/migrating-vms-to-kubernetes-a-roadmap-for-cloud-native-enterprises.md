...
summary: Kubernetes已成为主平台，但企业仍有大量VM。KubeVirt扩展Kubernetes，实现VM与容器统一管理，简化操作，提高效率，提供迁移路径。新电子书提供实践指南。
-->

Kubernetes已成为主平台，但企业仍有大量VM。KubeVirt扩展Kubernetes，实现VM与容器统一管理，简化操作，提高效率，提供迁移路径。新电子书提供实践指南。

> 译自：[Migrating VMs to Kubernetes: A Roadmap for Cloud Native Enterprises](https://thenewstack.io/migrating-vms-to-kubernetes-a-roadmap-for-cloud-native-enterprises/)
> 
> 作者：Janakiram MSV
