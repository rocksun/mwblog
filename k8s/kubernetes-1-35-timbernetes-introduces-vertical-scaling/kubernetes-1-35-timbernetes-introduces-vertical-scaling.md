<!--
title: Kubernetes 1.35 Timbernetes 来了：垂直扩容
cover: https://cdn.thenewstack.io/media/2025/12/ace5b492-kuberenetes-1.35.jpg
summary: Kubernetes v1.35代号“Timbernetes”，引入Pod资源原地更新、KYAML等60项增强。垂直扩展功能已稳定，弃用Ingress NGINX和cgroup v1。
-->

Kubernetes v1.35代号“Timbernetes”，引入Pod资源原地更新、KYAML等60项增强。垂直扩展功能已稳定，弃用Ingress NGINX和cgroup v1。

> 译自：[Kubernetes 1.35 "Timbernetes" Introduces Vertical Scaling](https://thenewstack.io/kubernetes-1-35-timbernetes-introduces-vertical-scaling/)
> 
> 作者：Joab Jackson
