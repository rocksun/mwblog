<!--
title: Docker 日志让你抓狂？试试这个可视化工具！
cover: https://cdn.thenewstack.io/media/2026/01/9682c352-chay-kelly-natcydo-uey-unsplash-1.jpg
summary: 本文介绍了 Dozzle，一个开源的基于网络的 Docker 容器日志查看工具，旨在简化故障排除。文章涵盖了 Docker 的安装以及 Dozzle 的部署和使用，强调其在实时日志监控方面的易用性。
-->

本文介绍了 Dozzle，一个开源的基于网络的 Docker 容器日志查看工具，旨在简化故障排除。文章涵盖了 Docker 的安装以及 Dozzle 的部署和使用，强调其在实时日志监控方面的易用性。

> 译自：[Docker logs got you down? Give this tool a try](https://thenewstack.io/docker-logs-got-you-down-give-this-tool-a-try/)
> 
> 作者：Jack Wallen
