<!--
title: Kubernetes v1.35：世界之树版本，代号“林网”
cover: https://kubernetes.io/blog/2025/12/17/kubernetes-v1-35-release/k8s-v1.35.png
summary: Kubernetes v1.35“世界之树”版发布（2025/12/17）。60项增强：Pod原地更新稳定、Pod证书测试、调度前节点声明Alpha。Ingress NGINX退役，cgroup v1和IPVS模式移除/弃用。
-->

Kubernetes v1.35“世界之树”版发布（2025/12/17）。60项增强：Pod原地更新稳定、Pod证书测试、调度前节点声明Alpha。Ingress NGINX退役，cgroup v1和IPVS模式移除/弃用。

> 译自：[Kubernetes v1.35: Timbernetes (The World Tree Release)](https://kubernetes.io/blog/2025/12/17/kubernetes-v1-35-release/)
> 
