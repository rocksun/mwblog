### 解锁 VictoriaMetrics 的强大功能：Prometheus 的替代方案
...
**可扩展性：**Victoria Metrics 被设计为在垂直和水平方向上都具有可扩展性。另一方面，Prometheus 在这方面做得不够，需要额外的工具（如 Thanos）来扩展。[⁸](#fn:last9-vm-vs-thanos)
