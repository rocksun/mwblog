<!--
title: Warp智能体编程：驾驭K8s集群管理新境界
cover: https://cdn.thenewstack.io/media/2025/10/f08b84ee-warp.png
summary: Warp是一款AI驱动的终端优先DevOps环境，通过代理简化Kubernetes集群安装。文章展示了如何用一个提示在Multipass VM上设置K8s 1.33、Calico和本地存储。
-->

Warp是一款AI驱动的终端优先DevOps环境，通过代理简化Kubernetes集群安装。文章展示了如何用一个提示在Multipass VM上设置K8s 1.33、Calico和本地存储。

> 译自：[How To Use Warp's Agentic Programming To Manage Kubernetes Clusters](https://thenewstack.io/how-to-use-warps-agentic-programming-to-manage-kubernetes-clusters/)
> 
> 作者：Janakiram MSV
