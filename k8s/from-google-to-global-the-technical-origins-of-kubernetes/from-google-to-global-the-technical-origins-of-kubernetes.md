...
summary: 揭秘 Kubernetes 技术起源！Borg 和 Omega 如何影响 Kubernetes 的核心设计？Pod、标签选择器、控制器等关键概念竟源于谷歌内部系统。从单体 Master 到 API Server，Kubernetes 架构演进之路。Docker 与 Kubernetes 的相遇，又碰撞出怎样的火花？一文读懂云原生编排王者 Kubernetes 的前世今生！
-->
