<!--
title: CNCF Dragonfly：P2P加速容器与模型共享
cover: https://cdn.thenewstack.io/media/2026/01/5b45a2fd-dragonfly.png
summary: CNCF Dragonfly项目毕业，作为P2P分发系统，它能高效加速容器和大型AI模型分发。被阿里云、蚂蚁集团、Datadog等广泛采用，显著提升了效率并节省带宽。
-->

CNCF Dragonfly项目毕业，作为P2P分发系统，它能高效加速容器和大型AI模型分发。被阿里云、蚂蚁集团、Datadog等广泛采用，显著提升了效率并节省带宽。

> 译自：[CNCF Dragonfly Speeds Container, Model Sharing with P2P](https://thenewstack.io/cncf-dragonfly-speeds-container-model-sharing-with-p2p/)
> 
> 作者：Joab Jackson
