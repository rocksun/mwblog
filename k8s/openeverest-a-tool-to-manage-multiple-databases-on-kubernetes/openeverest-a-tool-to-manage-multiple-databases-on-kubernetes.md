<!--
title: OpenEverest：Kubernetes 多数据库管理利器
cover: https://cdn.thenewstack.io/media/2026/01/f6effc63-simon-wuvnejwexbw-unsplash-openeverest.jpg
summary: Percona捐赠OpenEverest给CNCF。该Kubernetes数据库管理工具支持PostgreSQL、MySQL、MongoDB等，提供统一管理界面，旨在成为供应商中立的开源项目。
-->

Percona捐赠OpenEverest给CNCF。该Kubernetes数据库管理工具支持PostgreSQL、MySQL、MongoDB等，提供统一管理界面，旨在成为供应商中立的开源项目。

> 译自：[OpenEverest, a Tool To Manage Multiple Databases on Kubernetes](https://thenewstack.io/openeverest-a-tool-to-manage-multiple-databases-on-kubernetes/)
> 
> 作者：Joab Jackson
