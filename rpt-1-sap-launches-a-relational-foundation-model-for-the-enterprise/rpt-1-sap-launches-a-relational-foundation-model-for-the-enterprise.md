...
<!--
title: SAP重磅发布：企业级关系型基础模型震撼登场
cover: https://cdn.thenewstack.io/media/2025/11/2b1b7fb4-sap-teched-2025-scaled.jpg
summary: SAP发布首个企业关系型基础模型SAP-RPT-1，专为处理结构化业务数据和预测业务场景而设计。它无需额外训练，将于今年晚些时候上市，并提供开放权重模型。
-->

SAP发布首个企业关系型基础模型SAP-RPT-1，专为处理结构化业务数据和预测业务场景而设计。它无需额外训练，将于今年晚些时候上市，并提供开放权重模型。

> 译自：[RPT-1: SAP Launches a Relational Foundation Model for the Enterprise](https://thenewstack.io/rpt-1-sap-launches-a-relational-foundation-model-for-the-enterprise/)
> 
