...
<!--
title: 无盘Kafka：规模化运行的颠覆性变革
cover: https://cdn.thenewstack.io/media/2025/11/ae71e2c2-diskless-game-changer-running-kafka-scale.jpg
summary: Kafka因高成本和复杂性面临挑战。KIP-1150无盘主题利用对象存储，可将Kafka精简80%，降低成本。11月20日网络研讨会将探讨其智能架构。
-->

Kafka因高成本和复杂性面临挑战。KIP-1150无盘主题利用对象存储，可将Kafka精简80%，降低成本。11月20日网络研讨会将探讨其智能架构。

> 译自：[Why Diskless Is a Game-Changer for Running Kafka at Scale](https://thenewstack.io/why-diskless-is-a-game-changer-for-running-kafka-at-scale/)
> 
> 作者：Vicki Walker
