...
<!--
title: 从10分钟查询到实时仪表板：Everactive的工业物联网技术栈
cover: https://miro.medium.com/v2/da:true/resize:fit:1000/0*imHzicXKyeNH62r3
summary: Everactive用TimescaleDB替换OpenTSDB，构建工业物联网堆栈，实现无电池传感器实时分析。数据堆栈从六个减至三个，查询从10分钟降至亚秒级。利用PostgreSQL扩展，结合MQTT、Kafka，实现数据驱动的故障检测，降低成本，提升性能，简化了云原生基础设施。
-->
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/0*tBdKtKJCg6VGSmlF)
