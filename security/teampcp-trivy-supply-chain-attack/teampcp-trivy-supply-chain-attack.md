<!--
title: TeamPCP反噬Aqua Security：Trivy扫描器化身百万开发者“凶器”
cover: https://cdn.thenewstack.io/media/2026/03/11a2d25f-tri-wiranto-1xj4-u_mj_g-unsplash-scaled.jpg
summary: TeamPCP利用Aqua Security的Trivy扫描器发动大规模供应链攻击，窃取凭据，危害众多开源项目和开发者，暴露了GitHub Actions的漏洞。提醒需轮换凭据、锁定GitHub Actions以增强安全性。
-->

TeamPCP利用Aqua Security的Trivy扫描器发动大规模供应链攻击，窃取凭据，危害众多开源项目和开发者，暴露了GitHub Actions的漏洞。提醒需轮换凭据、锁定GitHub Actions以增强安全性。

> 译自：[How TeamPCP turned Aqua Security's own Trivy scanner into a weapon against millions of developers](https://thenewstack.io/teampcp-trivy-supply-chain-attack/)
> 
