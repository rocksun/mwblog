...
> 译自 [Limitations in Measuring Platform Engineering with DORA Metrics](https://thenewstack.io/limitations-in-measuring-platform-engineering-with-dora-metrics/)，作者 Nočnica Mellifera 在成为开发者关系专家之前是一个开发者长达7年。她专攻容器化工作负载、无服务器和公共云计算工程。
...
如果我们有一些通用的简单指标，可以跨团队和组织理解我们提升开发者速度的效果，那就太好了。在我[之前的文章](https://yylives.cc/2024/02/18/the-wrong-way-to-use-dora-metrics/)中，我讨论了使用 DevOps 研究与评估(DORA)指标不当的一些陷阱。在这篇文章中，我们将深入探讨使用 DORA 指标来评估平台工程。

为了清楚讨论 DORA 指标在评估团队健康方面的作用，我们必须面对一个最棘手的问题: DORA 指标是否是评估平台工程团队的有效工具。我的结论是，你不能根据 DORA 指标来评估你的平台工程团队。

在讨论 DORA 指标时，Datavant 的基础设施和开发者体验负责人 [Hazel Weakly](https://www.linkedin.com/feed/update/urn:li:activity:7137437870444744704/) 提到了 Mordecai 关于低风险指标的[概念](https://rambling.malignat.us/2022-08-27/lowstakes-and-highstakes-metrics?trk=public_post_comment-text):
...
当开发者对他们的工具和流程感到满意时，这是一个平台工程正在做得很好的强有力信号。最后，平台工程需要考虑采用他们的平台的[难易程度](https://thenewstack.io/how-to-be-an-effective-platform-engineering-team/);这种以用户为中心的指标在DORA指标的测量中不存在。

## 生成文化和心理安全感

谷歌以推广高绩效团队中“[心理安全感](https://www.nytimes.com/2016/02/28/magazine/what-google-learned-from-its-quest-to-build-the-perfect-team.html)”的必要性而闻名。虽然许多因素可能影响心理安全感，但毫无疑问，破坏团队[安全感](https://thenewstack.io/7-reasons-why-developer-experience-is-a-strategic-priority/)最频繁的因素是错误应用或不公平应用绩效评估。
